...
export default function WorkExperience() {
  ...
  return (
    <SectionCard editing={editing}>
      ...
      <h4>
        Software Engineer, Arch Global Services Incorporated (November 2023 -
        Present)
      </h4>
      <ul>
        <li>Develop pricing rater APIs under actuarial department</li>
        <li>
          Assist in improving developer experience for actuaries, enforcing
          coding standards and test-driven development
        </li>
        <li>
          App support and communication for production issues in coordination
          with Infrastructure, Underwriting IT and Policy Writing IT Teams
        </li>
      </ul>
      <h4>Statistical Data Scientist, GfK, (May 2022 - May 2023)</h4>
      <ul>
        <li>
          Develop internal web apps for linear optimization and missing retailer
          data modeling
        </li>
      ...
      <h4>
        Geotechnical and Structural Engineer, various companies, (2009 - May
        2022)
      </h4>
      <ul>
